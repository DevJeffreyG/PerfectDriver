...
public class SettingsInit : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //GameObject.Find("Canvas/PanelControles/PanelLuces/Button (7)").GetComponentInChildren<TMPro.TMP_Text>().text = profile.getSettings().getSetting(Settings.SettingName.Emergencia).ToString();
